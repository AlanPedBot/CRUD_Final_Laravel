...
<body id="bodyHome">
    ...
    <form method="post" action="">
        ...
        <div class="mx-auto" style="margin-top: 55px; text-align: center;">
            <h1 style="font-weight: bold;">Buscando Livros</h1>
            <p style="font-weight: bold;" class=" fs-2 ">Nome do livro</p>
            ...
            <div>
                <button type="submit" name="read" class="btn btn-primary btn-lg"
                    style="margin-top: 15px; font-weight: bold;">BUSCAR</button>
            </div>
            @if (session()->has('read'))
    ...
    @if ($books instanceof Illuminate\Pagination\LengthAwarePaginator)
        <nav style="background-color: #B0C4DE;">
            <ul class="pagination">
                {{-- Botão "Anterior" --}}
